...
namespace PictionaryMusicalServidor.Datos
{
    ...
    public class CatalogoCanciones : ICatalogoCanciones
    {
        ...
        private static readonly Dictionary<int, Cancion> _canciones = new Dictionary<int, Cancion>
        {
            ...
            { 3, CrearCancion(3, "La Nave Del Olvido", "JosÃ© JosÃ©", "Balada", "Espanol") },
            { 4, CrearCancion(4, "TiburÃ³n", "Proyecto Uno", "Merengue House", "Espanol") },
            { 5, CrearCancion(5, "Pupilas De Gato", "Luis Miguel", "Pop Latino", "Espanol") },
            { 6, CrearCancion(6, "El Triste", "JosÃ© JosÃ©", "Balada", "Espanol") },
            ...
            { 12, CrearCancion
                (12, "La Puerta Negra", "Los Tigres del Norte", "NorteÃ±o", "Espanol") },
            { 13, CrearCancion(13, "Baraja de Oro", "Chalino SÃ¡nchez", "Corrido", "Espanol") },
            ...
            { 16, CrearCancion(16, "El TelÃ©fono", "Wisin & Yandel", "Reggaeton", "Espanol") },
