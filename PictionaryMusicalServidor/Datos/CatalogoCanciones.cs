...
namespace PictionaryMusicalServidor.Datos
{
    ...
    public class CatalogoCanciones : ICatalogoCanciones
    {
        ...
        private static readonly Dictionary<int, Cancion> _canciones = new Dictionary<int, Cancion>
        {
            ...
            { 3, CrearCancion(3, "La Nave Del Olvido", "Jose Jose", "Balada", IdiomaEspanol) },
            { 4, CrearCancion(4, "Tiburon", "Proyecto Uno", "Merengue House", IdiomaEspanol) },
            ...
            { 12, CrearCancion
                (12, "La Puerta Negra", "Los Tigres del Norte", "Norteno", IdiomaEspanol) },
            { 13, CrearCancion(13, "Baraja de Oro", "Chalino Sanchez", "Corrido", IdiomaEspanol) },
            ...
            { 16, CrearCancion(16, "El Telefono", "Wisin & Yandel", "Reggaeton", IdiomaEspanol) },
