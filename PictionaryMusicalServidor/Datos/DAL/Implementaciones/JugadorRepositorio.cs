...
namespace PictionaryMusicalServidor.Datos.DAL.Implementaciones
{
    ...
    public class JugadorRepositorio : IJugadorRepositorio
    {
        ...
        public bool ExisteCorreo(string correo)
        {
            ...
            {
                _logger.ErrorFormat("Error de entidad al verificar existencia del correo '{0}'.", 
                    correo, ex);
                throw;
            }
        ...
        public Jugador CrearJugador(Jugador jugador)
        {
            ...
            {
                _logger.ErrorFormat("Error de actualizacion al guardar el jugador con correo '{0}'.", 
                    jugador.Correo, ex);
                throw;
            }
            catch (EntityException ex)
            {
                _logger.ErrorFormat("Error de entidad al guardar el jugador con correo '{0}'.", 
                    jugador.Correo, ex);
                throw;
            }
            catch (DataException ex)
