...
namespace PictionaryMusicalServidor.Servicios.Servicios.Autenticacion
{
    ...
    public class CambioContrasenaManejador : ICambioContrasenaManejador
    {
            ...
            (SolicitudRecuperarCuentaDTO solicitud)
        {
            ...
            {
                _logger.Warn(
                    MensajesError.Bitacora.ArgumentoNuloSolicitarCodigoRecuperacion, excepcion);
            ...
            (ConfirmacionCodigoDTO confirmacion)
        {
            ...
            {
                _logger.Error(MensajesError.Bitacora.ErrorBaseDatosConfirmarRecuperacion, excepcion);
        ...
        public ResultadoOperacionDTO ActualizarContrasena(ActualizacionContrasenaDTO solicitud)
        {
            ...
            {
                _logger.Error(
                    MensajesError.Bitacora.ErrorActualizacionBDContrasena, excepcion);
            ...
            {
                _logger.Error(
                    MensajesError.Bitacora.ErrorInesperadoActualizarContrasenaManejador,
                    excepcion);
